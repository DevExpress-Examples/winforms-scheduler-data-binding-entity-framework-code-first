...
'#End Region  ' #resmappings 
            AddHandler schedulerControl1.DataStorage.AppointmentsChanged, AddressOf Storage_AppointmentsModified
            AddHandler schedulerControl1.DataStorage.AppointmentsInserted, AddressOf Storage_AppointmentsModified
            AddHandler schedulerControl1.DataStorage.AppointmentsDeleted, AddressOf Storage_AppointmentsModified
